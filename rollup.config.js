...
const banner = `/*!
 * leaflet-getfeatureinfo-wms v${pkg.version} by Luis Bello <luisbello30@gmail.com> (https://about.me/luisbello30)
 * Source and issue tracking: https://github.com/luisbello30/Leaflet.GetFeatureInfoWMS
 *
    ...
    output: [
        {
            file: pkg.browser,
            format: 'umd',
            name: 'L.TileLayer.GetFeatureInfoWMS',
            globals: {leaflet: 'L'},
            banner,
            sourcemap: true,
        },
